...
namespace sict {
	...
	const double INTEREST_RATE = 0.05f;
	const double TRANSACTION_FEE = 0.50f;
	const double MONTHLY_FEE = 2.00f;
	...
	public:
		...
		//does it need to be declared? No because this is also an abstract class
